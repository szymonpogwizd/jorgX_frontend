...
import FormularzOpinia from '../FormularzOpinia'
    ...
    return (
        <div>
          <Header/>
                        ...
                        <div className="card rounded">
                          <div className="card-body">
                            ...
                            <p className='no-decoration'>
                              ...
                              Nullam nec tortor quis lacus vehicula tincidunt. 
                              Vestibulum pharetra felis nec diam tinc
                            </p>
                            <img src={zle} alt="Placeholder" />
                          </div>
                        </div>
            ...
            <div>
              <h1 id="napis-opini">Zostaw swoją opninię o tym miejscu</h1>
              <FormularzOpinia/>
            </div>
        </div>
    );
